...
class_name="org.cscie88c.spark.SilverJob"
arg_list="[\"s3://$BUCKET/data/silver\",\"s3://$BUCKET/data/taxi_zone_lookup.csv\",\"s3://$BUCKET/data/yellow_tripdata_2025-01.parquet\",\"s3://$BUCKET/data/silver/trips_conformed\"]"
set -x
